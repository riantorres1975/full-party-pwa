...
export default function CarritoDrawer({ items, total, isOpen, onCerrar, onAgregar, onReducir, onEliminar, onLimpiar, productos = [] }) {
  ...
  const handleConfirmar = async () => {
    ...
    // Mostrar pantalla de confirmación (sin guardar aún en Supabase)
    setPedidoGuardado({
      folio: null,
      url: null,
          ...
          {pedidoGuardado ? (
            <div className="flex flex-col items-center px-5 py-6 gap-4 animate-fade-in">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-ink-400 font-body mt-1">Revisa tu resumen y envíalo por WhatsApp</p>
              </div>
